...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-07: Selecting Custom domain reveals custom domain text input field
- Location: tests\interview\interview.spec.ts:45:3
...
Locator: locator('input[placeholder*="e.g. Snowflake"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="e.g. Snowflake"]')
...
- main:
  ...
  - button "Custom"
  - text: Define Custom Technology / Domain
  - textbox "e.g. Go (Golang) Microservices, C++ Embedded"
  - text: Target professional role
  - textbox "e.g. AWS Cloud Engineer, DevOps Lead, SRE": Custom
  ...
  - text: No curated questions in vault for this topic. Define custom topic or search details. Focus Topics / Key Skills (Optional)
