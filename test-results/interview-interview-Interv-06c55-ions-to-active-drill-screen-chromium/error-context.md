...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-18: Clicking Launch Interview Session transitions to active drill screen
- Location: tests\interview\interview.spec.ts:120:3
    ...
    - generic [ref=e24]:
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            - button "What is horizontal scaling vs vertical scaling in a cloud environment, and when is each appropriate?" [ref=e191] [cursor=pointer]:
              - img [ref=e194]
              - paragraph [ref=e197]: What is horizontal scaling vs vertical scaling in a cloud environment, and when is each appropriate?
            ...
            - button "What is cloud tenant isolation, and how do public cloud providers ensure secure multi-tenancy?" [ref=e205] [cursor=pointer]:
              - img [ref=e208]
              - paragraph [ref=e211]: What is cloud tenant isolation, and how do public cloud providers ensure secure multi-tenancy?
            - button "What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?" [ref=e212] [cursor=pointer]:
              - img [ref=e215]
              - paragraph [ref=e218]: What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?
            - button "Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware." [ref=e219] [cursor=pointer]:
              - img [ref=e222]
              - paragraph [ref=e225]: Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.
        - generic [ref=e226]:
