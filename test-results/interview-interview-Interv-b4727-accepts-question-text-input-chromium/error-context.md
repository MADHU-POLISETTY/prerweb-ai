...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-15: Custom question input field accepts question text input
- Location: tests\interview\interview.spec.ts:99:3
    ...
    - generic [ref=e24]:
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            - button "What are standard cloud security best practices for protecting data at rest and in transit?" [ref=e191] [cursor=pointer]:
              - img [ref=e194]
              - paragraph [ref=e197]: What are standard cloud security best practices for protecting data at rest and in transit?
            - button "Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control." [ref=e198] [cursor=pointer]:
              - img [ref=e201]
              - paragraph [ref=e204]: Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control.
            ...
            - button "How do Content Delivery Networks (CDNs) leverage edge caching to improve global latency?" [ref=e212] [cursor=pointer]:
              - img [ref=e215]
              - paragraph [ref=e218]: How do Content Delivery Networks (CDNs) leverage edge caching to improve global latency?
            - button "What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?" [ref=e219] [cursor=pointer]:
              - img [ref=e222]
              - paragraph [ref=e225]: What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?
        - generic [ref=e226]:
