...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-09: Target company input field accepts target company name
- Location: tests\interview\interview.spec.ts:58:3
...
Call log:
  - waiting for locator('input[placeholder*="e.g. Stripe, AWS"]')
    ...
    - generic [ref=e24]:
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            - button "Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control." [ref=e191] [cursor=pointer]:
              - img [ref=e194]
              - paragraph [ref=e197]: Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control.
            ...
            - button "Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware." [ref=e205] [cursor=pointer]:
              - img [ref=e208]
              - paragraph [ref=e211]: Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.
            - button "What is horizontal scaling vs vertical scaling in a cloud environment, and when is each appropriate?" [ref=e212] [cursor=pointer]:
              - img [ref=e215]
              - paragraph [ref=e218]: What is horizontal scaling vs vertical scaling in a cloud environment, and when is each appropriate?
            - button "What are standard cloud security best practices for protecting data at rest and in transit?" [ref=e219] [cursor=pointer]:
              - img [ref=e222]
              - paragraph [ref=e225]: What are standard cloud security best practices for protecting data at rest and in transit?
            - button "How does a multi-region cloud architecture provide high availability and geographical disaster recovery?" [ref=e226] [cursor=pointer]:
              - img [ref=e229]
              - paragraph [ref=e232]: How does a multi-region cloud architecture provide high availability and geographical disaster recovery?
            - button "What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?" [ref=e233] [cursor=pointer]:
              - img [ref=e236]
              - paragraph [ref=e239]: What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?
            - button "Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?" [ref=e240] [cursor=pointer]:
              - img [ref=e243]
              - paragraph [ref=e246]: Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?
            - button "What is cloud tenant isolation, and how do public cloud providers ensure secure multi-tenancy?" [ref=e247] [cursor=pointer]:
              - img [ref=e250]
              - paragraph [ref=e253]: What is cloud tenant isolation, and how do public cloud providers ensure secure multi-tenancy?
        - generic [ref=e254]:
          - generic [ref=e255]: Focus Topics / Key Skills (Optional)
          - textbox "e.g. Concurrency pipelines, system design" [ref=e256]
      - button "Compile Prep Session" [ref=e257] [cursor=pointer]:
        - img [ref=e258]
        - generic [ref=e260]: Compile Prep Session
  - navigation [ref=e261]:
    - button "Home" [ref=e262] [cursor=pointer]:
      - img [ref=e263]
      - generic [ref=e266]: Home
    - button "Interview" [active] [ref=e267] [cursor=pointer]:
      - img [ref=e268]
      - generic [ref=e270]: Interview
    - button "Resume" [ref=e271] [cursor=pointer]:
      - img [ref=e272]
      - generic [ref=e275]: Resume
    - button "Analytics" [ref=e276] [cursor=pointer]:
      - img [ref=e277]
      - generic [ref=e279]: Analytics
    - button "Profile" [ref=e280] [cursor=pointer]:
      - img [ref=e281]
      - generic [ref=e284]: Profile
```
