...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-23: Submitting answer triggers evaluation loading spinner state text
- Location: tests\interview\interview.spec.ts:151:3
