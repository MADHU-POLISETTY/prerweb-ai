...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-11: Clicking difficulty button updates active difficulty selection
- Location: tests\interview\interview.spec.ts:73:3
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            ...
            - button "What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?" [ref=e198] [cursor=pointer]:
              - img [ref=e201]
              - paragraph [ref=e204]: What are the key architectural differences and use cases for IaaS, PaaS, and SaaS cloud delivery models?
