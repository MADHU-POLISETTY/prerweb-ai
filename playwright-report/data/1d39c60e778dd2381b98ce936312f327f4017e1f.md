...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-17: Launch Interview Session button is visible and active
- Location: tests\interview\interview.spec.ts:115:3
...
Locator: locator('button').filter({ hasText: /Launch Interview Session/i })
Expected: visible
Timeout: 5000ms
...
- main:
  ...
  - button "Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.":
    - paragraph: Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.
