...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-13: Question mode switcher supports Dynamic AI and Custom Pinned modes
- Location: tests\interview\interview.spec.ts:85:3
...
Locator: locator('button').filter({ hasText: /Dynamic AI Generation/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: /Dynamic AI Generation/i })
