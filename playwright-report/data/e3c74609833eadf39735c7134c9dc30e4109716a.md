...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-14: Switching to Custom Pinned Mode reveals custom question input box
- Location: tests\interview\interview.spec.ts:92:3
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            ...
            - button "Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware." [ref=e198] [cursor=pointer]:
              - img [ref=e201]
              - paragraph [ref=e204]: Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.
            - button "Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control." [ref=e205] [cursor=pointer]:
              - img [ref=e208]
              - paragraph [ref=e211]: Compare Public Cloud, Private Cloud, and Hybrid Cloud architectures in terms of cost, security, and control.
            - button "Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?" [ref=e212] [cursor=pointer]:
              - img [ref=e215]
              - paragraph [ref=e218]: Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?
            - button "How do Content Delivery Networks (CDNs) leverage edge caching to improve global latency?" [ref=e219] [cursor=pointer]:
              - img [ref=e222]
              - paragraph [ref=e225]: How do Content Delivery Networks (CDNs) leverage edge caching to improve global latency?
        - generic [ref=e226]:
          - generic [ref=e227]: Focus Topics / Key Skills (Optional)
          - textbox "e.g. Concurrency pipelines, system design" [ref=e228]
      - button "Compile Prep Session" [ref=e229] [cursor=pointer]:
        - img [ref=e230]
        - generic [ref=e232]: Compile Prep Session
  - navigation [ref=e233]:
    - button "Home" [ref=e234] [cursor=pointer]:
      - img [ref=e235]
      - generic [ref=e238]: Home
    - button "Interview" [active] [ref=e239] [cursor=pointer]:
      - img [ref=e240]
      - generic [ref=e242]: Interview
    - button "Resume" [ref=e243] [cursor=pointer]:
      - img [ref=e244]
      - generic [ref=e247]: Resume
    - button "Analytics" [ref=e248] [cursor=pointer]:
      - img [ref=e249]
      - generic [ref=e251]: Analytics
    - button "Profile" [ref=e252] [cursor=pointer]:
      - img [ref=e253]
