...
- Name: interview\interview.spec.ts >> Interview Simulation Framework Specs >> INT-08: Target role title input field accepts custom text input
- Location: tests\interview\interview.spec.ts:52:3
...
Call log:
  - waiting for locator('input[placeholder*="e.g. Lead DevOps Engineer"]')
      ...
      - generic [ref=e135]:
        ...
        - generic [ref=e171]:
          ...
          - generic [ref=e190]:
            ...
            - button "Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?" [ref=e198] [cursor=pointer]:
              - img [ref=e201]
              - paragraph [ref=e204]: Explain the Shared Responsibility Model in cloud environments. Who is responsible for patching guest operating systems?
            ...
            - button "Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware." [ref=e212] [cursor=pointer]:
              - img [ref=e215]
              - paragraph [ref=e218]: Explain the role of virtualization in cloud computing and how hypervisors enable multiple operating systems on physical hardware.
